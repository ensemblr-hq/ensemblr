...
import {
	...
	reducePiTimeline,
} from '@/renderer/lib/pi-replay';
import type {
	PiTimelineInput,
	PiTimelineState,
} from '@/renderer/types/pi-replay';
import type { PiCapturedLine } from '@/shared/pi-rpc';
import { piCapturedLineSchema } from '@/shared/pi-rpc';

import { PiSessionStatusBar } from './pi-session-status-bar.tsx';
import { PiTimeline } from './pi-timeline.tsx';
