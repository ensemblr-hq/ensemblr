...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: shadcn InputGroup wraps inputs without a form-control fieldset to preserve flex/has() styling.
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: addon must remain a flex child of InputGroup; a <fieldset> would reset styling and tab order.
		// biome-ignore lint/a11y/useKeyWithClickEvents: addon proxies focus to the sibling input — keyboard users reach the input directly, so no key handler is needed.
		<div
			role='group'
