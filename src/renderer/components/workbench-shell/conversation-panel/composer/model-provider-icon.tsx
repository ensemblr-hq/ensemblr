...
// Claude's star mark (`logos:claude-icon` from @iconify-json/logos), the one
// case with its own viewBox: the source art is 256×257, not the 24×24 the
// simple-icons marks above share.
const CLAUDE_PATH =
