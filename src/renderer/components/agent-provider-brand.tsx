...
/**
 * Mark and tinted swatch for each agent runtime. Claude's terracotta is the
 * vendor's own literal because it does not belong in the app's theme tokens;
 * Pi borrows Ensemblr's accent since it is the house runtime.
 */
export const AGENT_PROVIDER_BRAND: Record<
	AgentProviderId,
	{ Logo: (props: { className?: string }) => React.ReactElement; tint: string }
> = {
	claude: { Logo: ClaudeLogo, tint: 'bg-[#d97757]/12 text-[#d97757]' },
