...
export default interface Resources {
	...
	settings: {
		...
		git: {
			...
			'co-author': {
				description: "Ask agents to end every commit they make with `{{trailer}}`. GitHub credits the trailer to the Ensemblr account, so it appears alongside you in the repository's contributors.";
				label: 'Credit Ensemblr as a commit co-author';
			};
			'delete-branch': {
		...
		models: {
			...
			description: "Agent models, thinking-level defaults, delegation roles, and runtime policy for new chats, reviews, and the Concierge. Sourced from each configured runtime's capability discovery.";
			...
			orchestration: {
				'claude-native': {
					action: 'Open Providers';
					description: 'Claude Code’s built-in sub-agents bypass Ensemblr delegation and cannot use these role preferences or cross-runtime routing. Choose Ensemblr chat tabs for new Claude chats to use this feature.';
					label: 'Claude Code delegation';
				};
				'cross-runtime': {
					'aria-label': 'Allow cross-runtime delegation';
					description: 'Lets Ensemblr-managed children explicitly run on another configured runtime and model provider. Omitted models still inherit the caller’s runtime. Filesystem permissions and cost approvals do not change.';
					label: 'Allow cross-runtime delegation';
				};
				empty: {
				...
				roles: {
					builder: {
						description: 'Routine implementation from an established pattern';
						name: 'Builder';
					};
					coder: {
						description: 'Novel code with unresolved design choices';
						name: 'Coder';
					};
					explorer: {
					...
					grunt: {
						description: 'Mechanical work; no judgment required';
						name: 'Grunt';
					};
					label: 'Delegation roles';
					sage: {
						description: 'Reasoning, architecture, and difficult tradeoffs';
						name: 'Sage';
					};
				};
				'save-failed': 'Could not save model orchestration settings. Your latest change may not be saved.';
				'search-placeholder': 'Search models, runtimes, providers…';
				unavailable: {
					clear: 'Clear';
					'clear-aria-label': 'Clear roles for {{model}}';
					description: 'These models are hidden or were not reported by discovery. Their roles remain saved until you clear them.';
					title: 'Unavailable saved assignments';
				};
			};
			'review-model': {
		...
		providers: {
			...
			'read-only-tools': {
				add: 'Add';
				'add-aria': 'Tool name to trust';
				'add-placeholder': 'Tool name';
				description: 'Plan Mode and the Concierge refuse tools Ensemblr cannot vouch for. Trust a tool here only if it cannot change files, run commands, or act on your accounts.';
				empty: 'No extra tools found.';
				error: {
					duplicate: '{{name}} is already trusted.';
					empty: 'Enter a tool name.';
					'has-policy': 'Ensemblr already has a rule for {{name}}, so it cannot be trusted here.';
					'not-mcp': 'On Claude Code only MCP tools can be trusted, named mcp__server__tool.';
					'too-long': 'Tool names are at most {{max}} characters long.';
				};
				label: 'Read-only tools';
				'load-failed': 'Ensemblr could not read this runtime’s tools.';
				'not-applied': 'Ignored: Ensemblr decides about this tool itself.';
				'not-reported': 'Start a conversation on this runtime to list the extra tools it holds.';
				'not-seen': 'Not seen since launch';
				refused: 'Refused';
				'trust-aria': 'Trust {{name}} as read-only';
			};
	...
	workbench: {
		...
		'afk-mode': {
			...
			warning: {
				acknowledge: 'Turn on AFK';
				acknowledgment: 'Use it cautiously and sparingly. Turning it on acknowledges this warning, so you will not see it again.';
				'best-work': 'While you are away, AFK mode gives agents room to plan, build, review, and refine—pushing for their absolute best work without waiting for you.';
				'go-back': 'Not now';
				title: 'Before you turn on AFK';
		...
		'archive-workspace': {
			...
			'settings-unavailable': 'Your git settings could not be read, so the local branch will be kept.';
		...
		'browse-archive': {
			description: 'Restore an archived workspace, or permanently purge it. Archiving kept its branch and a snapshot of any uncommitted changes, so restoring rebuilds the workspace from git.';
			empty: {
		...
		composer: {
			...
			'queued-message-empty': 'The queued message is empty. Edit or remove it before resuming the queue.';
		...
		'control-tool': {
			...
			linear: {
				...
				'omitted-comments_one': '{{count}} earlier comment did not fit.';
				'omitted-comments_other': '{{count}} earlier comments did not fit.';
				'omitted-issues_one': '{{count}} more issue did not fit — narrow the search.';
				'omitted-issues_other': '{{count}} more issues did not fit — narrow the search.';
				priority: 'priority {{priority}}';
				'unknown-author': 'Unknown';
			};
			...
			'notify-orchestrator': {
				done: 'Notified the parent chat';
				running: 'Notifying the parent chat';
			};
			'open-tab': {
				done: 'Opened a tab';
			...
			preview: {
				'agents-pending_one': '{{count}} still working';
				'agents-pending_other': '{{count}} still working';
				'agents-settled_one': '{{count}} settled';
				'agents-settled_other': '{{count}} settled';
			...
			review: {
				'already-resolved-heading': 'Already resolved';
				archived: 'Archived';
				'by-agent': 'Agent';
				'by-user': 'You';
			...
			status: {
				'note-label': 'Note:';
				'report-label': 'Report:';
				'report-none': 'None yet';
				'report-ready': 'Ready to read';
			...
			terminal: {
				idle: 'idle';
				tail_one: 'last {{lines}} lines · {{count}} earlier hidden';
				tail_other: 'last {{lines}} lines · {{count}} earlier hidden';
			};
			transcript: {
				answer: 'Answer';
				error: 'Error';
			...
			wait: {
				'pending-heading': 'Still working';
				'report-truncated': 'report truncated';
				'settled-heading': 'Settled';
				signal: 'signal: {{reason}}';
			};
			'wait-for-agents': {
				chat: {
					done: 'Waited for chats';
					running: 'Waiting for chats';
				};
				concierge: {
		...
		'follow-up-queue': {
			...
			'status-paused-stopped': 'Paused — you stopped the turn';
		...
		'navigation-sidebar': {
			...
			update: {
				...
				downloading: {
					description: 'A restart is offered here as soon as it finishes.';
					title: 'Downloading Ensemblr {{version}}';
				};
				failed: {
					description: 'The download did not finish. Try again, or take the release page instead.';
					title: 'Ensemblr {{version}} did not download';
				};
				'open-release': 'Open the release page';
				ready: {
					description: 'Restart to finish installing. Agents still working are asked first.';
		...
		'tool-call': {
			...
			'background-tasks': {
				'attested-title': 'Start attested Pi run';
				'delegate-title': 'Delegate in background';
				'fusion-investigate-title': 'Start Fusion investigation';
				'fusion-reason-title': 'Start Fusion reasoning';
				'fusion-research-title': 'Start Fusion research';
				'fusion-title': 'Start Fusion workflow';
				'fusion-validate-title': 'Start Fusion validation';
				head: 'head';
				'kill-title': 'Stop background task';
				'logs-title': 'Read background logs';
				'result-title': 'Read background result';
				'run-title': 'Start background task';
				state: {
					artifact: 'artifact';
					cancelled: 'cancelled';
					committed: 'ready';
				...
				'status-title': 'Check background tasks';
				tail: 'tail';
				'task-count_one': '{{count}} task';
				'task-count_other': '{{count}} tasks';
				truncated: 'truncated';
			};
			bash: {
			...
			'web-access': {
				'character-count_one': '{{count, number}} char';
				'character-count_other': '{{count, number}} chars';
				'fetch-title': 'Fetch web content';
				'match-query-count_one': '{{count}} match query';
				'match-query-count_other': '{{count}} match queries';
				'query-count_one': '{{count}} query';
				'query-count_other': '{{count}} queries';
				'read-title': 'Read stored web content';
				'result-count_one': '{{count}} result';
				'result-count_other': '{{count}} results';
				'search-title': 'Search the web';
				'source-check-title': 'Check web sources';
				'source-count_one': '{{count}} source';
				'source-count_other': '{{count}} sources';
				'url-count_one': '{{count}} URL';
				'url-count_other': '{{count}} URLs';
			};
			write: {
				title: 'Write';
			};
