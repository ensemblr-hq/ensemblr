		...
		workspaces: [
			{
				...
				pullRequest: {
					checks: [
						{
							...
							provider: 'github',
							status: 'ready',
							url: 'https://github.com/ensemblr-hq/ensemblr/actions/runs/102',
						},
					],
					comments: [
						{
							author: 'linear',
							body: 'Linked to [ENG-106](https://linear.app/example-org/issue/ENG-106).',
							createdAt: '2026-07-20T09:12:00.000Z',
							detail: 'Linked to ENG-106.',
							id: 'linear-linkback',
							provider: 'linear',
						},
						{
					...
					title: 'ENG-102 Rework workbench shell',
					todos: [],
				},
				reviewFiles: [
					{
					...
					checks: [
						{
							...
							provider: 'github',
							status: 'pending',
							url: 'https://github.com/ensemblr-hq/ensemblr/actions/runs/118',
						},
					],
					comments: [],
					description: [
				...
				sessions: [
					{
						...
						agentSessionId: null,
						status: 'idle',
						summary: 'Future agent session seeded from Linear metadata.',
						updatedLabel: '1h ago',
					},
				],
					...
					checks: [
						{
							...
							provider: 'github',
							status: 'ready',
							url: 'https://github.com/ensemblr-hq/ensemblr/actions/runs/129',
						},
					],
					comments: [],
					description: [
