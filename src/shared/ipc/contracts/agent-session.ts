...
/**
 * Pi CLI IPC surface. Executable discovery and overrides live on the
 * provider-parameterized `AgentProviderApi`; slash commands stay here because
 * they are a Pi CLI feature with no sibling on other runtimes.
 */
