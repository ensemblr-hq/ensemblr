...
export const IPC_CHANNELS = {
	...
	listRepositoryBranches: 'ensemble:list-repository-branches',
	listRepositoryPullRequests: 'ensemble:list-repository-pull-requests',
	listRepositoryIssues: 'ensemble:list-repository-issues',
