...
- **Settings > Providers — \`providers\`:** \`claudeSubagentMode\` selects Ensemblr chat-tab delegation (\`ensemblr\`) or Claude Code native sub-agents (\`native\`). Pi ignores this preference. It does not install a runtime or change its executable.
