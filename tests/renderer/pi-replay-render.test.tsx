/**
 * Renders the real Pi replay component set against the final reduced state of
...
import { PiSessionStatusBar } from '../../src/renderer/components/pi-replay/pi-session-status-bar';
import { PiTimeline } from '../../src/renderer/components/pi-replay/pi-timeline';
import { replayPiTimeline } from '../../src/renderer/lib/pi-replay';
import type { PiTimelineState } from '../../src/renderer/types/pi-replay';
