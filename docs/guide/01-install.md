...
| Option | Does |
| --- | --- |
| `--version <tag>` | install a specific release, e.g. `--version v0.1.16` |
...
The current build is **`0.1.16`**:

- [**`Ensemblr-0.1.16-arm64.dmg`**](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.16/Ensemblr-0.1.16-arm64.dmg)
  — the macOS disk image. Open it and drag Ensemblr to `/Applications`.
- [`Ensemblr-darwin-arm64-0.1.16.zip`](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.16/Ensemblr-darwin-arm64-0.1.16.zip)
  — the same `.app`, zipped, if you would rather not mount an image.
- [**`Ensemblr-0.1.16-x64.AppImage`**](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.16/Ensemblr-0.1.16-x64.AppImage)
...
The app reports the full version, any prerelease suffix included — `0.1.16` in
