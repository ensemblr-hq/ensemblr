...
The current build is **`0.1.0-beta.9`**:

- [**`Ensemblr-0.1.0-beta.9-arm64.dmg`**](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.9/Ensemblr-0.1.0-beta.9-arm64.dmg)
  — the disk image. Open it and drag Ensemblr to `/Applications`.
- [`Ensemblr-darwin-arm64-0.1.0-beta.9.zip`](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.9/Ensemblr-darwin-arm64-0.1.0-beta.9.zip)
...
The app reports the full version, suffix included — `0.1.0-beta.9` in
