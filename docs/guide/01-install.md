...
The current build is **`0.1.0-beta.12`**:

- [**`Ensemblr-0.1.0-beta.12-arm64.dmg`**](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.12/Ensemblr-0.1.0-beta.12-arm64.dmg)
  — the disk image. Open it and drag Ensemblr to `/Applications`.
- [`Ensemblr-darwin-arm64-0.1.0-beta.12.zip`](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.12/Ensemblr-darwin-arm64-0.1.0-beta.12.zip)
...
The app reports the full version, suffix included — `0.1.0-beta.12` in
