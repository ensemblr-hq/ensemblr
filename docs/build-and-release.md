...
```bash
gh release create v0.1.0-beta.14 --notes-file NOTES.md --prerelease
```
...
```json
{
  "url": "https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.14/Ensemblr-darwin-arm64-0.1.0-beta.14.zip",
  "name": "0.1.0-beta.14",
