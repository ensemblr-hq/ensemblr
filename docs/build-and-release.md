...
```bash
gh release view v0.1.15 --json assets -q '.assets[].name'
```
...
```bash
gh api repos/ensemblr-hq/ensemblr/releases/tags/v0.1.15 \
...
```json
{
  "url": "https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.15/Ensemblr-darwin-arm64-0.1.15.zip",
  "name": "0.1.15",
  "notes": "…the release body…",
  "pub_date": "2026-09-13T10:48:27Z"
}
```
