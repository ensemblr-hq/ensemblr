...
```bash
gh release create v0.1.9 --notes-file NOTES.md
```
...
```bash
gh release view v0.1.9 --json assets -q '.assets[].name'
```
...
```bash
gh api repos/ensemblr-hq/ensemblr/releases/tags/v0.1.9 \
...
```json
{
  "url": "https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.9/Ensemblr-darwin-arm64-0.1.9.zip",
  "name": "0.1.9",
  "notes": "…the release body…",
  "pub_date": "2026-09-08T09:26:28Z"
}
```
