...
```bash
gh release create v0.1.2 --notes-file NOTES.md
```
...
```bash
gh api repos/ensemblr-hq/ensemblr/releases/tags/v0.1.2 \
...
```json
{
  "url": "https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.2/Ensemblr-darwin-arm64-0.1.2.zip",
  "name": "0.1.2",
  "notes": "…the release body…",
  "pub_date": "2026-09-03T23:12:40Z"
}
```
