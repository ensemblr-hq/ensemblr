...
```bash
gh release create v0.1.0-beta.22 --notes-file NOTES.md --prerelease
```
...
```json
{
  "url": "https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.22/Ensemblr-darwin-arm64-0.1.0-beta.22.zip",
  "name": "0.1.0-beta.22",
