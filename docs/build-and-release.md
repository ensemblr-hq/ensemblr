...
```bash
gh release create v0.1.5 --notes-file NOTES.md
```
...
```bash
gh api repos/ensemblr-hq/ensemblr/releases/tags/v0.1.5 \
...
```json
{
  "url": "https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.5/Ensemblr-darwin-arm64-0.1.5.zip",
  "name": "0.1.5",
  "notes": "…the release body…",
  "pub_date": "2026-09-07T07:35:43Z"
}
```
