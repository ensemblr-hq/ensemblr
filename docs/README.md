...
The current build is [`0.1.0-beta.22`](https://github.com/ensemblr-hq/ensemblr/releases/tag/v0.1.0-beta.22), for macOS on Apple silicon and Linux on x86-64. [Download the `.dmg`](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.22/Ensemblr-0.1.0-beta.22-arm64.dmg) — signed, notarized and stapled — or the [`.AppImage`](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.22/Ensemblr-0.1.0-beta.22-x64.AppImage), which is unsigned. You bring your own agent CLI — Pi or Claude Code, one is enough — plus `git` and an authenticated `gh`.
