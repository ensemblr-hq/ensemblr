...
The current build is [`0.1.0-beta.11`](https://github.com/ensemblr-hq/ensemblr/releases/tag/v0.1.0-beta.11) — signed, notarized, Apple silicon only. [Download the `.dmg`](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.11/Ensemblr-0.1.0-beta.11-arm64.dmg). You bring your own agent CLI — Pi or Claude Code, one is enough — plus `git` and an authenticated `gh`.
