...
| [`mvp-sequencing.md`](./mvp-sequencing.md) | The original milestone 0–5 build order plus the deferred-until-post-core list, written to fix implementation sequence ahead of Conductor parity work. | `docs/product/implementation-roadmap.md` — *Roadmap Sequence* for the milestone order, *Milestone Dependencies* for the constraints, *Completed Implementation* for evidence. Its deferred list survives verbatim as *Explicitly deferred until post-core*. |
