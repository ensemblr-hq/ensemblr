...
Piductor uses `gh` CLI for v1 GitHub integration and targets Conductor parity for PR/check/merge workflows.

## Decision

Piductor will use a Conductor-style merge confirmation flow.
...
- Piductor matches Conductor's two-step ready/confirm merge ergonomics.
