# 0019. Defer Ensemblr Account for V1
...
Ensemblr v1 will not require or implement an Ensemblr account/sign-in.
...
Any Ensemblr-owned app account, cloud sync, team features, billing, or hosted service integration is deferred. This does not defer external integration login such as Linear OAuth.

## Consequences

- Setup is simpler and local-first.
- Ensemblr does not need account token storage in v1.
