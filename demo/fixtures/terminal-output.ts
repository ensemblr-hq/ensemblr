...
export const DEV_SERVER_OUTPUT = [
	...
	'',
	`${DIM}11:19:44${RESET} ${CYAN}[vite]${RESET} hmr update ${GREEN}/src/renderer/components/workbench-shell/navigation-sidebar/update-panel/update-panel.tsx${RESET}`,
...
export const SHELL_OUTPUT = [
	...
	` ${YELLOW}M${RESET} src/renderer/components/workbench-shell/navigation-sidebar/update-panel/update-panel.tsx`,
