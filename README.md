...
- **Version:** [`0.1.16`](https://github.com/ensemblr-hq/ensemblr/releases/tag/v0.1.16) (stable)
- **License:** Apache-2.0
...
Ensemblr is **stable at 0.1.16**, released 2026-09-13. The core workflows —
...
Or **[Download Ensemblr 0.1.16 (.dmg, Apple silicon)](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.16/Ensemblr-0.1.16-arm64.dmg)** — open it and drag Ensemblr to Applications.
...
[`docs/adr/`](./docs/adr) (70 Architecture Decision Records) ·
