...
- **Version:** [`0.1.5`](https://github.com/ensemblr-hq/ensemblr/releases/tag/v0.1.5) (stable)
- **License:** Apache-2.0
...
Ensemblr is **stable at 0.1.5**, released 2026-09-07. The core workflows —
...
Or **[Download Ensemblr 0.1.5 (.dmg, Apple silicon)](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.5/Ensemblr-0.1.5-arm64.dmg)** — open it and drag Ensemblr to Applications.
...
[`docs/adr/`](./docs/adr) (63 Architecture Decision Records) ·
