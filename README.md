...
**[Download Ensemblr 0.1.0-beta.3 (.dmg, Apple silicon)](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.3/Ensemblr-0.1.0-beta.3-arm64.dmg)** — open it and drag Ensemblr to Applications.
