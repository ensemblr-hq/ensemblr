...
- **Version:** [`0.1.0-beta.12`](https://github.com/ensemblr-hq/ensemblr/releases/tag/v0.1.0-beta.12) (pre-1.0, polish stage)
...
Or **[download Ensemblr 0.1.0-beta.12 (.dmg, Apple silicon)](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.0-beta.12/Ensemblr-0.1.0-beta.12-arm64.dmg)** — open it and drag Ensemblr to Applications.
