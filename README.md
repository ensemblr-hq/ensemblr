...
- **Version:** [`0.1.22`](https://github.com/ensemblr-hq/ensemblr/releases/tag/v0.1.22) (stable)
- **License:** Apache-2.0
...
Ensemblr is **stable at 0.1.22**, released 2026-09-24. The core workflows —
...
Or download Ensemblr 0.1.22 (.dmg): **[Apple silicon](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.22/Ensemblr-0.1.22-arm64.dmg)** · **[Intel](https://github.com/ensemblr-hq/ensemblr/releases/download/v0.1.22/Ensemblr-0.1.22-x64.dmg)** — open it and drag Ensemblr to Applications.
...
[`docs/adr/`](./docs/adr) (71 Architecture Decision Records) ·
